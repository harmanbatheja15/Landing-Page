		...
		<>
			<div className=''>
				<div className='flex flex-col-reverse md:flex-row items-center justify-between'>
					<h1
						className='text-[48px] xl:text-[84px] font-bold text-[#67FFD1] mx-auto lg:mt-auto lg:mb-32 text-transparent bg-clip-text xl:leading-[100px] leading-[57px]'
						style={{
					...
					/> */}
					<div className='relative w-full h-screen max-w-screen overflow-hidden'>
						<canvas
							ref={canvasRef}
							id='canvas3d'
							onMouseDown={handleMouseDown}
							className={`w-full h-full absolute top-0 lg:-right-[180px] ${isInteracting ? 'pointer-events-auto' : 'pointer-events-none overflow-hidden'}`}
						/>
					</div>
				</div>
